...
\texttt{os.remove}), and 89 benign false-positive traps covering typical
...
breakdown. All 89 benign cases are correctly permitted (zero false positives).
...
Across all regulated cases: $\mathcal{L} = 0$ for all 89 benign actions
